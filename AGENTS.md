...
- 项目使用 vinext 来驱动 Next.js 框架，在编写代码之前请先阅读 `node_modules/next/dist/docs/` 和 `node_modules/vinext/README.md` 中的相关文档。
...
无论用户使用何种语言提问或表达，你必须且只能使用**简体中文（Simplified Chinese）**进行思考、分析、输出以及调用工具，不要包含任何其他语言的解释。
